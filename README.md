...
This starter kit contains the pre-requsite account and software necessary for the 
PCT Core chain smart contract Workshopmended to use a machine that is running either Linux or MacOS
...
The Workshop requires fundamental understanding of the following software development concepts and tooling.
...
## Contribute
For change request, please clone and submit pull-request.